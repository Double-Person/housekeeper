<template>
	<view class="index">
		...
		<button type="default" class="button" @click="_technicianUpaateforeman">提交</button>
	</view>
</template>

<script>
		import {technicianUpaateforeman, upLoadFile} from "@/components/api/api.js"
	...
	export default {
		...
		methods:{	
			...
			_technicianUpaateforeman(order_id) {
