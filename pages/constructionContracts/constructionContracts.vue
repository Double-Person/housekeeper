<template>
	<view class="contract">
		...
		<view class="page" id="page1">
			...
			<view class="fl a-i-center jc-center"><text class="serial-number">甲方：</text><input type="text" v-model="form.value2" class="contract-input" /></view>
		...
		<view class="page" id="page2">
			...
			<view class="fl a-i-center"><text class="serial-number">联系方式：</text>0816—2859598</view>
			...
			<view class="point">（一）、工程名称：<input type="text" class="contract-input" v-model="form.value11" /></view>
			<view class="point">（二）、工程地址：<input type="text" class="contract-input" v-model="form.value12" /></view>
			<view class="point">（三）、工程范围：（ 详见“世隆房管”APP施工方案详情）</view>
			<view class="point">（四）、承包方式： 双方商定采取乙方包工、包全部材料;</view>
			<view class="point">（五）、合同价款：￥<input type="text" class="date-input" v-model="form.value13"/>元，大写(人民币)：<input type="text" class="date-input" v-model="form.value14" /></view>
			...
			<view class="point">
				...
				<text class="keywords">APP</text>验收记录上确认
					<text class="keywords">签字</text>。验收不合
			</view>
		...
		<view class="page" id="page3">
			...
			<view class="point">
				双方商定本合同价款采用固定价格，甲方分2次支付合同款项：第1次支付合同总价款的<input type="text" class="date-input" v-model="form.value22" />% ，竣工验收合格后甲方
		...
		<view class="page" id="page5">
			...
			<view class="fl jc-between">
				<view class="signature">
					...
					<view class="fl a-i-center"><text class="serial-number">代理人：</text><input type="text" class="date-input-ml" v-model="form.value27" /></view>
				...
				<view class="signature">
					...
					<view class="fl a-i-center"><text class="serial-number">代理人：</text><input type="text" class="date-input-ml" v-model="form.value31" /></view>
