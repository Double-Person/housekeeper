    ...
    <view class="list-view">
      ...
      >
        <view class="block">
          ...
          <!-- 施工页面 -->
          <view
            class="state jc-around"
            v-if="statusObj.CONSTRUCTION == currentTabBar"
          >
            <text
              :class="audit === 'review' ? 'statAct' : ''"
              @click="subType('review')"
          ...
          <view v-if="!topBarList[topActive].hasNext">
            <view v-if="statusObj.COMPLETE != currentTabBar">
              <fromDeatil
                msg="msg"
                :item="item"
                v-for="(item, index) in topBarList[topActive].list"
                :key="index"
              ></fromDeatil>
            </view>
            <view v-if="statusObj.COMPLETE == currentTabBar">
              ...
              >
                <view class="slot-warp">
                  <view class="slot-active" @click="questionnaireSurvey"
                    >问卷调查</view
                  >
                </view>
              </fromDeatil>
          ...
          <view v-if="topBarList[topActive].hasNext">
            ...
            <view class="state" v-if="statusObj.AUDIT == currentTabBar">
              <fromDeatil
                ...
                v-for="(item, index) in topBarList[topActive].list[currentType]
                  .list"
                :key="index"
              >
                <view class="slot-warp">
                  <view class="slot-not-active" @click="notThrough"
                    >不通过</view
                  >
