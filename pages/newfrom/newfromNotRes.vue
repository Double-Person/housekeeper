<template>
	<view class="index">
		...
		<button type="default" class="button" @click="_receivingorders">提交</button>
	</view>
</template>

<script>
		import {receivingorders, upLoadFile} from "@/components/api/api.js"
