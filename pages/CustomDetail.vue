<template>
	<view class="index">
		...
		<!-- 照片 -->
		<view class="order_img" v-if="false">
			<view class="title">
				照片
			</view>
			<view class="img_data">
		...
		<!-- 备注 -->
		<view class="order_txt" v-if="false">
			<view class="title">
				备注
			</view>
			<view class="txt_data">
...
<script>
import { programmeApiList, aftersaleApiConstruction } from "@/components/api/api.js"
...
import { showMsg } from "@/utils/showMsg.js"
	export default {
		...
		onLoad(opt) {
			...
			// 
			if(opt.type == 'order') {
				this._aftersaleApiConstruction(this.info.orderquality_id)
			}
			console.log(this.info)
		},
		methods: {
			// 订单审核详情
			_aftersaleApiConstruction(orderquality_id) {
